    ...
    <div className="">
      ...
      <div className="flex justify-center">
        <div className="  absolute -translate-y-6 py-7 focus:outline-gray-900 bg-white shadow-inner shadow-gray-200  border border-gray-300 rounded-lg  px-6 ">
          <h2 className="font-400 text-center text-xl pb-5 -translate-y-1">
            Log in to Facebook
          </h2>
          <br />
          <input
            className="border pr-4 px-5 py-4 focus:outline-none -translate-y-7 rounded-md font-[Arial] font-[500] placeholder-gray-500 placeholder-opacity-80 text-lg  w-full focus:placeholder-gray-300 "
            type="email"
            name="email"
            id=""
          ...
          <br />
          <input
            className="border border-gray-300 focus:outline-none    pr-44 px-5 py-4 font-[Arial]   rounded-md  -translate-y-2 placeholder-gray-500 placeholder-opacity-80 placeholder:text-lg focus:placeholder-gray-300 "
            type="password"
            name="password"
            id=""
          ...
          <br />
          <input
            className="  border-[#0866FF]  bg-[#0879FF] translate-y-1   py-2 px-40 ml- rounded-md text-white text-2xl font-[500] hover:bg-[#0870FF] hover:inset-80 hover:duration-100 "
            type="button"
            value="Log in"
          />
          <p className="  translate-y-5 text-md translate-x-9 text-opacity-80  text-blue-600  font-[Verdana] cursor-pointer hover:underline">
            Forgotten account? ·
          </p>
          <div className=" text-center -translate-y-2 translate-x-24 pt-1">
            {" "}
            <span className="  hover:underline font-[Verdana] text-md font-[500] text-blue-600 text-opacity-80  cursor-pointer">
